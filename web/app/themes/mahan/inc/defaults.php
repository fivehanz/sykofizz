...
if ( ! function_exists( 'martanda_get_defaults' ) ) {
	...
	function martanda_get_defaults() {
		$martanda_defaults = array(
			...
			'navigation_text_color' => '#111111',
			'navigation_background_hover_color' => '#ffffff',
			'navigation_text_hover_color' => '#da5155',
			'navigation_background_current_color' => '',
			'navigation_text_current_color' => '#111111',
			'subnavigation_background_color' => '#111111',
			'subnavigation_text_color' => '#ffffff',
			'subnavigation_background_hover_color' => '#111111',
			'subnavigation_text_hover_color' => '#da5155',
